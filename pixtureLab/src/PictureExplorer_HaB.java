 ...
 */
public class PictureExplorer_HaB implements MouseMotionListener, ActionListener, MouseListener
{
   ...
   */
  public PictureExplorer_HaB(DigitalPicture picture)
  {
    // set the fields
  ...
  {
    Picture pix = new Picture("src/images/team254.jpg");
    Picture smallPicture = pix.scale(0.25,0.25);
    smallPicture.write("src/images/smalteam254.jpg");
    pix.explore();
  }
